...
library Impl {
    ...
    function getDecryptResult(uint256 input) internal returns (uint256) {
        return ITaskManager(TASK_MANAGER_ADDRESS).getDecryptResult(input);
    }

    function getDecryptResultSafe(uint256 input) internal returns (uint256 result, bool decrypted) {
...
library FHE {
    ...
    /// @return The decrypted uint256 value
    function getDecryptResult(uint256 input1) internal returns (uint256) {
    ...
    function getDecryptResultSafe(ebool input1) internal returns (bool result, bool decrypted) {
    ...
    /// @return decrypted Flag indicating if the value was successfully decrypted
    function getDecryptResultSafe(euint8 input1) internal returns (uint8 result, bool decrypted) {
    ...
    /// @return decrypted Flag indicating if the value was successfully decrypted
    function getDecryptResultSafe(euint16 input1) internal returns (uint16 result, bool decrypted) {
    ...
    /// @return decrypted Flag indicating if the value was successfully decrypted
    function getDecryptResultSafe(euint32 input1) internal returns (uint32 result, bool decrypted) {
    ...
    /// @return decrypted Flag indicating if the value was successfully decrypted
    function getDecryptResultSafe(euint64 input1) internal returns (uint64 result, bool decrypted) {
    ...
    /// @return decrypted Flag indicating if the value was successfully decrypted
    function getDecryptResultSafe(euint128 input1) internal returns (uint128 result, bool decrypted) {
    ...
    /// @return decrypted Flag indicating if the value was successfully decrypted
    function getDecryptResultSafe(euint256 input1) internal returns (uint256 result, bool decrypted) {
    ...
    /// @return decrypted Flag indicating if the value was successfully decrypted
    function getDecryptResultSafe(eaddress input1) internal returns (address result, bool decrypted) {
    ...
    /// @return result The decrypted uint256 value
    /// @return decrypted Flag indicating if the value was successfully decrypted
    function getDecryptResultSafe(uint256 input1) internal returns (uint256 result, bool decrypted) {
